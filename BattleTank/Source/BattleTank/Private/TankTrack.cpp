...
void UTankTrack::ApplySidewaysForce()
{
	...
	// Calculate required acceleration this from to correct sliding
	auto SlipSpeed = FVector::DotProduct(GetRightVector(), GetComponentVelocity());
	auto CorrectionAcceleration = -SlipSpeed / GetWorld()->GetTimeSeconds() * GetRightVector();

	// Calculate and apply sideays force
	auto CorectionForce = (TankRoot->GetMass() * CorrectionAcceleration) / 2;
